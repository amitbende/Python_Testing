...
MultiSelect_City.select_by_value("1")
MultiSelect_City.select_by_value("3")
MultiSelect_City.select_by_value("5")
MultiSelect_City.select_by_value("6")
MultiSelect_City.select_by_value("7")
