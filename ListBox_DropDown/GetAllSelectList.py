...
multi_city = Select(Cities)

# Selecting options by index
multi_city.select_by_index(0)
multi_city.select_by_index(2)
multi_city.select_by_index(3)
multi_city.select_by_index(5)
multi_city.select_by_index(6)
multi_city.select_by_index(7)

# Wait
time.sleep(2)

# Get text of All selected options
selected_options = multi_city.all_selected_options
